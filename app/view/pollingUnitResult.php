  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active" aria-current="page" href="../view/pollingUnitResult.php">
            POLLING UNITS </a>
        <a class="nav-link active" aria-current="page" href="../view/pollingUnitTotalResult.php">
            POLLING UNITS TOTAL RESULT
        </a>
        <a class="nav-link active" aria-current="page" href="../view/createNewPollingUnit.php">
